...
> 🇬🇧 English: [README.md](README.md) · [DEPLOY.md](DEPLOY.md)
...
kendisi. Üs tanımı, bölge eşleşmesi veya ölçüm eksikse panel sayı uydurmak
yerine "hesaplanamıyor" diyor. Kademe gerçekten görülmediyse "elle atanmış"
diye işaretleniyor.
...
Docker veya systemd ile: **[DEPLOY.tr.md](DEPLOY.tr.md)**. Headless sunucuda
